...
config = {
	...
	'resolution': 256,
	'samples': 256,
	'stardis_samples': 1024,
	'range_low': 250,
	'range_high': 500,
	'light': 'Directional',                                 # Light source
	'template': 'templates/heater_bunny_box_moved1_ro',
	...
	'target_path': f'datasets/heater_bunny_box_moved1_ro'              # Path where the generated files are stored to
}
