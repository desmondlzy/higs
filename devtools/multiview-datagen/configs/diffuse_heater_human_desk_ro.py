...
from .utils import set_seed; set_seed(42)
# radius = 1
...
config = {
	...
	'template': 'templates/heater_human_desk_ro',
	...
	'target_path': f'datasets/heater_human_desk_ro'              # Path where the generated files are stored to
}
