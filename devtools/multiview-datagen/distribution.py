...
class Sphere(Distribution):
    ...
    def __init__(self, sampler_config: EasyDict=EasyDict({'module': 'sampler.Independent', 'd': 2}), u_range: list=[0,1.], v_range: list=[0,1.]) -> None:
...
class AABB(Distribution):
    ...
    def __init__(self, sampler_config: EasyDict=EasyDict({'module': 'sampler.Independent', 'd': 3}), b_0: Union[float, list]=0., b_1: Union[float, list]=1.) -> None:
        super().__init__(sampler_config)
...
class Constant(Distribution):
    ...
    def __init__(self, constants: list=[[0]]) -> None:
        super().__init__(EasyDict({'module': 'sampler.Sampler', 'n': len(constants)}))
...
def Range(n: int=128, b_0: Union[float, list]=0., b_1: Union[float, list]=1.):
    ...
    return AABB(EasyDict({'module': 'sampler.Grid', 'n': n}), b_0, b_1)
...
class Concat(Distribution):
    ...
    def __init__(self, distribution_config_0: EasyDict, distribution_config_1: EasyDict) -> None:
        ...
        super().__init__(EasyDict({'module': 'sampler.Sampler', 'n': max_size}))
